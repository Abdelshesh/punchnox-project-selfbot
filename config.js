const token = "NzAzMzA2MjA4OTExNjg3Njgw.YN3Y_A.bzXDULZP9-J1pKHAxkSncZ76Blw"; //tu met ton token entre les guillemets
const prefix = "/"; //tu met ton prefix entre les guillemets
const image = "https://images.app.goo.gl/e3bAFbospzxiN3VN9"; //tu met le lien de ton image entre les guillemets
const color = "FF0000"; //tu met ton la couleur (EXEMPLE RANDOM, RED, BLACK) ou un code couleur html comme #0CDF7C, #0F0000 dispo sur ce site ou autre https://htmlcolorcodes.com/fr/
const twitch = "wsh wsh"; //tu met ton lien twitch ici 
